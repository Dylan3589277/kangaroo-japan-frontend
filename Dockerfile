...
ARG NEXT_PUBLIC_YAHOO_DEPOSIT_RECHARGE_PAGE_PATH
ARG NEXT_PUBLIC_CANDY_DEPOSIT_RECHARGE_PAGE_PATH
ENV KANGAROO_JAPAN_BACKEND_ORIGIN=$KANGAROO_JAPAN_BACKEND_ORIGIN \
    NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY=$NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY \
    NEXT_PUBLIC_TURNSTILE_SITE_KEY=$NEXT_PUBLIC_TURNSTILE_SITE_KEY \
    NEXT_PUBLIC_YAHOO_DEPOSIT_RECHARGE_PAGE_PATH=$NEXT_PUBLIC_YAHOO_DEPOSIT_RECHARGE_PAGE_PATH \
    NEXT_PUBLIC_CANDY_DEPOSIT_RECHARGE_PAGE_PATH=$NEXT_PUBLIC_CANDY_DEPOSIT_RECHARGE_PAGE_PATH
RUN npm run build
