...
/**
 * 经典版（浅色通用样式）Mercari 商品详情页正文。
 *
 * 从原 [lang]/mercari/[id]/page.tsx 原样抽出，逻辑与样式一字不改，供非 en 语言渲染。
 * en 语言改由 MercariDetailDesignA（设计 A 深色）渲染，两者共用同一份取数/报价/售罄/
 * Buy now/Add to cart 逻辑，互不影响。
 */
export function MercariDetailClassic() {
