 ...
 * 复用 Mercari ZhMercariList 的版式/交互，数据源换成 GET /integrations/torecacamp/list。
...
function ZhTorecacampCard({
  ...
  return (
    <Link
      ...
      className={`group flex h-full w-full flex-col overflow-hidden rounded-xl border border-zinc-100 bg-white shadow-sm transition-all hover:-translate-y-0.5 hover:border-green-200 hover:shadow-md ${
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-zinc-100">
        ...
        <span className="absolute left-2 top-2 inline-flex items-center rounded-md bg-emerald-500 px-2 py-0.5 text-[10px] font-semibold text-white shadow-sm">
          Torecacamp
        </span>
...
function ZhTorecacampCardSkeleton() {
  return (
          ...
          <form onSubmit={handleSearch} className="mx-auto max-w-2xl">
            <div className="relative">
              <input
                ...
                className="h-12 w-full rounded-full border border-zinc-200 bg-white px-6 pr-24 text-zinc-900 placeholder:text-zinc-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 h-9 -translate-y-1/2 rounded-full bg-emerald-600 px-6 text-sm font-medium text-white transition-colors hover:bg-emerald-700"
              >
                {t("submit")}
              </button>
            </div>
      ...
      <section className="mx-auto w-full max-w-7xl px-4">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-sm text-zinc-500">
            <span className="inline-block h-4 w-1 rounded-full bg-gradient-to-b from-emerald-500 to-green-400" />
            <span>
          ...
          <label className="flex items-center gap-2 text-sm text-zinc-600">
            ...
            <select
              ...
              className="rounded-full border border-zinc-200 bg-white px-4 py-1.5 text-sm text-zinc-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
            >
        ...
        {loading ? (
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {Array.from({ length: 10 }).map((_, i) => (
              <ZhTorecacampCardSkeleton key={i} />
            ))}
          </div>
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-200 bg-white py-16 text-center">
            ...
            <button
              ...
              className="mt-4 rounded-full bg-emerald-600 px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-emerald-700"
            >
              {t("seePopular")}
            </button>
          </div>
